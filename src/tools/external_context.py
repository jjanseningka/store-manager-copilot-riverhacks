...
HOLIDAYS: list[dict[str, Any]] = [
    ...
    {"date": "2024-12-26", "name": "Boxing Day / 2nd Christmas", "region": "DE,NL,SE,UK", "impact": "high"},
    {"date": "2024-12-31", "name": "New Year's Eve", "region": "all", "impact": "medium"},
]

# IKEA promotion calendar (synthetic but realistic)
PROMOTIONS: list[dict[str, Any]] = [
    {"start": "2024-01-02", "end": "2024-01-21", "name": "New Year Sale", "category": "all", "discount_pct": 20},
    {"start": "2024-02-05", "end": "2024-02-25", "name": "Bedroom Week", "category": "Bedroom", "discount_pct": 15},
    {"start": "2024-03-04", "end": "2024-03-24", "name": "Spring Refresh", "category": "Living Room", "discount_pct": 15},
    {"start": "2024-04-08", "end": "2024-04-28", "name": "Kitchen Event", "category": "Kitchen", "discount_pct": 20},
    {"start": "2024-05-06", "end": "2024-05-26", "name": "Outdoor Living", "category": "Outdoor", "discount_pct": 15},
    {"start": "2024-06-03", "end": "2024-06-23", "name": "Summer Sale", "category": "all", "discount_pct": 25},
    {"start": "2024-07-01", "end": "2024-07-21", "name": "Storage Solutions", "category": "Storage", "discount_pct": 15},
    {"start": "2024-08-05", "end": "2024-08-31", "name": "Back to School / Student Living", "category": "all", "discount_pct": 20},
    {"start": "2024-09-09", "end": "2024-09-29", "name": "Cosy Autumn", "category": "Living Room", "discount_pct": 15},
    {"start": "2024-10-07", "end": "2024-10-27", "name": "Bathroom Event", "category": "Bathroom", "discount_pct": 20},
    {"start": "2024-11-25", "end": "2024-12-01", "name": "Black Friday Week", "category": "all", "discount_pct": 30},
    {"start": "2024-12-02", "end": "2024-12-22", "name": "Holiday Gift Guide", "category": "Decoration", "discount_pct": 15},
]
...
def get_seasonal_context(today: pd.Timestamp) -> dict[str, Any]:
    ...
    return {
        ...
        "demand_label": (
            "High demand" if pattern.get("demand_factor", 1.0) >= 1.15
            else "Normal demand" if pattern.get("demand_factor", 1.0) >= 0.95
...
def get_store_context(today: pd.Timestamp, bu_sk: int) -> dict[str, Any]:
    ...
    relevant_events = [
        ...
        if e["region"] == "all" or region in e["region"]
    ]
